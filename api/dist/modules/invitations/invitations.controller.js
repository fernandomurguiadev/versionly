...
__decorate([
    (0, common_1.Post)('workspaces/:wsId/invitations'),
...
__decorate([
    (0, common_1.Delete)('workspaces/:wsId/invitations/:id'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Param)('wsId', uuid_validation_pipe_1.UuidValidationPipe)),
    __param(2, (0, common_1.Param)('id', uuid_validation_pipe_1.UuidValidationPipe)),
    __metadata("design:type", Function),
