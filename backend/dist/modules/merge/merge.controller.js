...
const create_merge_dto_1 = require("./dto/create-merge.dto");
...
], MergeController.prototype, "getConflicts", null);
__decorate([
    (0, common_1.Post)('documents/:docId/merge'),
    (0, common_1.UseGuards)(document_role_guard_1.DocumentRoleGuard),
    (0, document_roles_decorator_1.DocumentRoles)(client_1.DocumentRole.editor),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Param)('docId', uuid_validation_pipe_1.UuidValidationPipe)),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, create_merge_dto_1.CreateMergeDto]),
    __metadata("design:returntype", void 0)
], MergeController.prototype, "createMerge", null);
exports.MergeController = MergeController = __decorate([
    (0, common_1.Controller)(),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    __metadata("design:paramtypes", [merge_service_1.MergeService])
], MergeController);
//# sourceMappingURL=merge.controller.js.map